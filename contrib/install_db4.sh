...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cryptowithacause repository."
  exit 1
fi
...
echo
echo 'When compiling cryptowithacaused, run `./configure` in the following way:'
echo
