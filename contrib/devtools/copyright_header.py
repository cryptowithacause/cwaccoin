...
EXCLUDE = [
    # auto generated:
    'src/qt/cryptowithacausestrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    "The cryptowithacause developers\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The cryptowithacause developers'
...
Arguments:
    <base_directory> - The base directory of a cryptowithacause source code repository.
"""
