...
from fake_stake.base_test import cryptowithacause_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(cryptowithacause_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zcwcstake']] * self.num_nodes
