...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("cryptowithacause Core cryptowithacause-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptowithacause-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptowithacause transaction") + "\n" +
                               "  cryptowithacause-tx [options] -create [commands]   " + _("Create hex-encoded cryptowithacause transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptowithacause transaction
