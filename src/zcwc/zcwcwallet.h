...
#ifndef cryptowithacause_ZCWCWALLET_H
#define cryptowithacause_ZCWCWALLET_H
...
public:
    CzCWCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCWC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCWC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //cryptowithacause_ZCWCWALLET_H
