...
#ifndef cryptowithacause_ZCWCTRACKER_H
#define cryptowithacause_ZCWCTRACKER_H
...
public:
    CzCWCTracker(std::string strWalletFile);
    ~CzCWCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCWCWallet* zCWCWallet = NULL);
...
#endif //cryptowithacause_ZCWCTRACKER_H
