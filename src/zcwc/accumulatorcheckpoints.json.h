...
#ifndef cryptowithacause_ACCUMULATORCHECKPOINTS_JSON_H
#define cryptowithacause_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //cryptowithacause_ACCUMULATORCHECKPOINTS_JSON_H
