                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCWCPathCustom = GetArg("-zcwcbackuppath", "");
    ...
    if(!strzCWCPathCustom.empty()) {
        ui->wallet_customzcwcbackuppath->setText(QString::fromStdString(strzCWCPathCustom));
        ui->wallet_customzcwcbackuppath_label->setVisible(true);
        ui->wallet_customzcwcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCWCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the cryptowithacause RPC console.") + "<br>" +
