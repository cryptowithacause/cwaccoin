...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::CWC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizecryptowithacauseAmount"))
        SoftSetArg("-anonymizecryptowithacauseamount", settings.value("nAnonymizecryptowithacauseAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cryptowithacause.cpp during shotdown to also remove the window positions
