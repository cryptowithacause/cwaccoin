...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("cryptowithacause Core"),
     ...
     * override -datadir in the cryptowithacause.conf file in the default data directory
     * (to be consistent with cryptowithacaused behavior)
     */
    if (dataDir != getDefaultDataDirectory())
