...
/** Utility functions used by the cryptowithacause Qt UI.
 */
namespace GUIUtil
{
...
// Render cryptowithacause addresses in monospace font
...
// Parse "cryptowithacause:" URI into recipient object, return true on successful parsing
