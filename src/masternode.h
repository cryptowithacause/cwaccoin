...
#define MASTERNODE_MIN_CONFIRMATIONS 21
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 CWC, signature to prove
