...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop cryptowithacause server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "cryptowithacause server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cryptowithacause features */
        {"cryptowithacause", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptowithacause", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptowithacause", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryptowithacause", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cryptowithacause", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cryptowithacause", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cryptowithacause", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptowithacause", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptowithacause", "startmasternode", &startmasternode, true, true, false},
        {"cryptowithacause", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptowithacause", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptowithacause", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptowithacause", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptowithacause", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptowithacause", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptowithacause", "preparebudget", &preparebudget, true, true, false},
        {"cryptowithacause", "submitbudget", &submitbudget, true, true, false},
        {"cryptowithacause", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryptowithacause", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryptowithacause", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryptowithacause", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryptowithacause", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryptowithacause", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryptowithacause", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryptowithacause", "checkbudgets", &checkbudgets, true, true, false},
        {"cryptowithacause", "mnsync", &mnsync, true, true, false},
        {"cryptowithacause", "spork", &spork, true, true, false},
        {"cryptowithacause", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzcwcseed", &getzcwcseed, false, false, true},
        {"zerocoin", "setzcwcseed", &setzcwcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzcwc", &searchdzcwc, false, false, true},
        {"zerocoin", "dzcwcstate", &dzcwcstate, false, false, true},
...
{
    return "> cryptowithacause-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18459/\n";
}
