Contributing to cryptowithacause Core
============================

The cryptowithacause Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cryptowithacause-project/cryptowithacause/blob/master/doc/translation_process.md)
...
The following applies to code changes to the cryptowithacause Core project, and is not to be
confused with overall cryptowithacause Network Protocol consensus changes.

Whether a pull request is merged into cryptowithacause Core rests with the project merge
...
Patches that change cryptowithacause consensus rules are considerably more involved than
...
Where a patchset proposes to change the cryptowithacause consensus, it must have been
...
The project leader is the release manager for each cryptowithacause Core release.
